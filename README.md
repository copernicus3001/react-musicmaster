Do poprawnego działania tej aplikacji wymagany jest token, który trzeba uzyskać od Spotify. Niestety działa on tylko przez godzinę, no chyba że coś robię źle. 
